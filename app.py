...
def getHeader():
    ...
    processImage(image=image, rectDimensions=(200, 10),
                 boxWidthTresh=1, boxHeightTresh=1, folder="processing", outputImagePrefix="header_concept_2", savePreprocessingImages=True)
...
def cropHeaderBox2(image):
    ...
    cv2.imwrite("temp/header_box_2.png", image)
