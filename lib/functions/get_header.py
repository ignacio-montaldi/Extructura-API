...
from lib.models.invoice_header_model import InvoiceHeader

from lib.functions.get_header_concept import getHeaderConcept
from lib.functions.get_header_concept_improved import getHeaderConceptImproved
from lib.functions.get_vat_conditions import getVatCondition
...
def getHeader():
    ...
    header = InvoiceHeader(
        ...
        vat_condition=getVatCondition(
            getHeaderConcept(img_file="processing/header_concept_2_3.png")
        ),
